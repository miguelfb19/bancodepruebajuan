...
export const Phone = ({ size = 20, className = "" }: Size) => (
  <svg
    width={size}
    height={size}
    className={className}
...
export const Mail = ({ size = 20, className = "" }: Size) => (
  <svg
    width={size}
    height={size}
    className={className}
...
export const Pin = ({ size = 20, className = "" }: Size) => (
  <svg
    width={size}
    height={size}
    className={className}
...
export const Facebook = ({ size = 20, className = "" }: Size) => (
  <svg
    width={size}
    height={size}
    className={className}
...
export const Instagram = ({ size = 20, className = "" }: Size) => (
  <svg
    width={size}
    height={size}
    className={className}
